  ...
  return (
    <div className="shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
        ...
        <div className="flex items-center rounded-full border border-gray-400 py-2 pr-4 pl-6 shadow-md">
        ...
        <div className="flex items-center rounded-full border border-gray-400 py-2 pr-4 pl-6 shadow-md gap-2">
         <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
