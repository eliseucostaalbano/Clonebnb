  ...
  return (
    <header className="shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-8">
        ...
        <Link
          to="/"
          className="hidden items-center rounded-full border border-gray-400 py-2 pr-4 pl-6 shadow-md lg:flex"
        >
        ...
        <Link
          to={user ? "/conta/perfil" : "/login"}
          className="flex items-center gap-2 rounded-full border border-gray-400 py-2 pr-4 pl-6 shadow-md"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
          ...
          {user ? (
            <p className="max-w-20 truncate sm:max-w-32">{user.nome}</p>
          ) : (
            <></>
          )}
        </Link>
